...
public static final Hand[] hand ={ //じゃんけんの手を表す３つのインスタンス
	new Hand(HANDVALUE_GUU),
	new Hand(HANDVALUE_CHO),
	new Hand(HANDVALUE_PAA),
};
private static final String[] name ={ //じゃんけんの手の文字列を表現
	"グー","チョキ","パー",
};
...
public boolean isStrongerThan(Hand h){ //thisがhより強い時true
	return fight(h) == 1;
}
public boolean isWeekerThan(Hand h){ //thisがhより弱い時true
	return fight(h) == -1;
}
